...
When we have M variables for which we want to build a network, there are also M predictors for each variable. THe regression coefficients are gatherd in a square matrix. The diagonal of this matrix represents the effects of Y_t-1 on Y_t, controlled for the other predictors.
